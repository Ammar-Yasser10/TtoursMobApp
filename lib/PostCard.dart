...
class PostCard extends StatelessWidget {
  ...
  checkPostDetails(BuildContext myContext) {
    Navigator.of(myContext)
        .pushNamed('/postdetails', arguments: {'Post': post});
  }
  ...
  Widget build(BuildContext context) {
    ...
    var vcategory = routeArgs['category'];
    print(vcategory!.id);
    return InkWell(
      onTap: () => Navigator.of(context)
          .pushNamed('/PostDetailsRoute', arguments: {'Post': post}),
      //  Navigator.of(context)
      //     .pushNamed('postdetails', arguments: {'Category': vcategory}),
      //  Navigator.push(
      //     context,
      //     MaterialPageRoute(
      //         builder: (context) => PostDetails({Category: vcategory}))),
      // Navigator.push(
      //   context,
      //   MaterialPageRoute(builder: (post) => PostDetailsPage()),
      // ),
      child: Card(
